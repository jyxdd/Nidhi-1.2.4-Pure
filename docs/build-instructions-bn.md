...
### ৬. **লিঙ্ক টাইম অপ্টিমাইজেশান (LTO) সাপোর্ট**
- পারফরম্যান্সের জন্য কার্নেল বাইনারি অপ্টিমাইজ করে
- **Thin LTO** সাপোর্ট করে (ডিফল্ট, ভারসাম্যপূর্ণ)
- **Full LTO** সাপোর্ট করে (সর্বোচ্চ পারফরম্যান্স, সম্ভাব্য অস্থিরতা)
- `none` দিয়ে নিষ্ক্রিয় করার অপশন আছে
...
| --lto [type] | -L | LTO মোড (thin, full, none) | `--lto thin`, `-L full` |
...
# LTO সহ
bash build.sh lmi --lto thin     # ডিফল্ট
bash build.sh lmi --lto full     # Full LTO
bash build.sh lmi --lto none     # LTO নিষ্ক্রিয় করুন
```
...
### ৬. লিঙ্ক টাইম অপ্টিমাইজেশান (-L, --lto)

**LTO কি?**
লিঙ্ক টাইম অপ্টিমাইজেশান কম্পাইলারকে মডিউল বাউন্ডারি জুড়ে অপ্টিমাইজ করার অনুমতি দেয়, যার ফলে সম্ভাব্য দ্রুত এবং আরও দক্ষ কার্নেল তৈরি হয়।

**মোড:**
- **Thin LTO (`thin`)**: [ডিফল্ট]
    - বিল্ড টাইম এবং পারফরম্যান্সের মধ্যে ভালো ভারসাম্য।
    - Full LTO-এর চেয়ে কম মেমরি ব্যবহার করে।
    - বেশিরভাগ ব্যবহারকারীর জন্য সুপারিশকৃত।

- **Full LTO (`full`)**:
    - সর্বোচ্চ সম্ভাব্য পারফরম্যান্স অপ্টিমাইজেশান।
    - বিল্ড করতে অনেক বেশি সময় নেয়।
    - অনেক বেশি RAM ব্যবহার করে।
    - **সতর্কতা**: কিছু ডিভাইসে বুটলুপের কারণ হিসেবে পরিচিত (যেমন, স্প্ল্যাশ স্ক্রিনে আটকে থাকা)।

- **No LTO (`none`)**:
    - সম্পূর্ণরূপে LTO নিষ্ক্রিয় করে।
    - দ্রুততম বিল্ড টাইম।
    - ডিবাগিং বা LTO সমস্যা সৃষ্টি করলে দরকারী।

**ব্যবহার:**
```bash
# স্পষ্টভাবে Thin LTO ব্যবহার করুন
bash build.sh lmi --lto thin

# Full LTO ব্যবহার করুন (সতর্কতা!)
...
| LTO সাপোর্ট | ম্যানুয়াল কনফিগ | `--lto [thin|full|none]` |
